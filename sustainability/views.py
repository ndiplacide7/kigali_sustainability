...
from .models import District, Sector, EnergyConsumption, WasteManagement, GreenSpace, PublicTransportation, AirQualityStation, AirQualityReading, CitizenInitiative
...
# Add similar views for other models (EnergyConsumption, WasteManagement, etc.)